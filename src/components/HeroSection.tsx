        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <div className="space-y-2">
              <motion.p 
                className="text-hackathon-purple dark:text-hackathon-blue font-medium"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <motion.h2 
                className="text-2xl md:text-3xl font-semibold bg-gradient-to-r from-hackathon-blue to-hackathon-purple bg-clip-text text-transparent animate-glow"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
